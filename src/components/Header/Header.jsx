...
const Header = () => {
  return (
    <div className="px-3 flex sm:px-24 bg-[#ffffff] w-full shadow-lg sm:py-4 py-4 items-center gap-1.5 sm:gap-5 flex-wrap">
      {/* Logo */}
      <Logo />
      {/* Search Box */}
      <SearchBox />
      ...
      <div className="add-btn">
        <NavLink
          to={"/addnote"}
          className="flex justify-between items-center w-fit gap-0.5 sm:gap-1 bg-[#3FA2F6] 
